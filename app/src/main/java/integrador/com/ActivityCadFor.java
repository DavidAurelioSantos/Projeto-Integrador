...
import integrador.com.Domain.ZipCodeListenerFor;
import integrador.com.Pojo.Address;

public class ActivityCadFor extends AppCompatActivity {
...
//    };
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cadfornecedores);

        txtNome = findViewById(R.id.txtNome_f);
        txtDDDComercial = findViewById(R.id.txtDDDComercial_f);
        txtTelComercial = findViewById(R.id.txtTelComercial_f);
        txtDDDCelular = findViewById(R.id.txtDDDCelular_f);
        txtCelular = findViewById(R.id.txtCelular_f);
        txtCPF = findViewById(R.id.txtCNPJCPF_f);
        txtRg = findViewById(R.id.txtRG_f);
        btSalvar_f = findViewById(R.id.btSalvar_f);
        txtcep = (EditText) findViewById(R.id.txtCep_f);

        // Ação ao clicar no botão Enviar Cadastro e verifica se os campos obrigatórios estão preenchidos
        btSalvar_f.setOnClickListener(new View.OnClickListener() {
            @Override
...
//        }
        ...
        txtcep.addTextChangedListener( new ZipCodeListenerFor(this) );

        Spinner spStates = (Spinner) findViewById(R.id.spEstado_f);
        ...
        Spinner spRegimeTributacao = (Spinner) findViewById(R.id.spinnerRegime_f);
...
//    }
    ...
    public void setDataViews(Address address){
        setField( R.id.txtEndereco_f, address.getLogradouro() );
        setField( R.id.txtComplemento_f, address.getComplemento() );
        setField( R.id.txtBairro_f, address.getBairro() );
        setField( R.id.txtCidade_f, address.getLocalidade() );
        setSpinner( R.id.spEstado_f, R.array.estados, address.getUf() );
    }
    ...
    public void searchZipCodeFor(View view){
        Intent intent = new Intent(this, ZipCodeSearchActivityFor.class);
